...
const cv::Mat Utilities::BruteforceConstrast(const cv::Mat mat, const double contrastPercentage) {
...
const cv::Mat Utilities::BruteforceBrightness(const cv::Mat mat, const int brightnessOffset) {
